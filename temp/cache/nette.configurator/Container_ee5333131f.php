<?php
// source: C:\laragon\www\PrvotniVerzeAdminu/config/common.neon
// source: C:\laragon\www\PrvotniVerzeAdminu/config/services.neon
// source: array
...
class Container_ee5333131f extends Nette\DI\Container
{
	...
	public function createServiceApplication__presenterFactory(): Nette\Application\IPresenterFactory
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback(
			$this,
			5,
			'C:\laragon\www\PrvotniVerzeAdminu/temp/cache/nette.application/touch',
		));
	...
	{
		return new Nette\Caching\Storages\FileStorage('C:\laragon\www\PrvotniVerzeAdminu/temp/cache');
	}
	...
	{
		$service = new Nette\Database\Connection('mysql:host=127.0.0.1;dbname=posts', /*sensitive{*/'root'/*}*/, null, []);
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\LatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\LatteFactory {
			public function __construct(
				private Container_ee5333131f $container,
			) {
			}
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('C:\laragon\www\PrvotniVerzeAdminu/temp/cache/latte');
